...
<body>                          
    <div class="row .payment-dialog-row">
        ...
        while($price = mysqli_fetch_array($Record)){
          echo"<div class='col-12'><input type='submit' id='submit' class='btn btn-success btn-lg d-block w-100' name='upload' value='Pay Rs: $price[price]' </div>";     
        }
        ?>
                ...
                if(isset($_POST['upload'])){
                    ...
                    <form id='payment-form' method='POST'>
                    <div class='row'>
                            <div class='col-12'><button class='btn btn-success btn-lg d-block w-100' type='submit' name='receipt'>Receipt</button></div>
                        </div> 
                    </form>
                    </div>";
                }
                ...
                if(isset($_POST['receipt'])){
                    ...
                    swal({
                            ...
                            window.location = 'receipt2.php?price=$price';
                        });
